...
import (
	"github.com/cloudinn/gokogiri/html"
...
found in the github.com/cloudinn/gokogiri/xml package. The xml.StrictParsingOption is conveniently provided for standards-compliant
behaviour.
*/
